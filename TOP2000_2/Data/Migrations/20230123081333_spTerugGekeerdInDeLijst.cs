...
{
    /// <inheritdoc />
    public partial class spTerugGekeerdInDeLijst : Migration
    {
        // terug van weg geweest
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("CREATE PROCEDURE spTerugGekeerdInDeLijst");
        ...
        {
            migrationBuilder.Sql(@"DROP procedure spTerugGekeerdInDeLijst");
        }
    }
}
