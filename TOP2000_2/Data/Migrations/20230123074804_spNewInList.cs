...
{
    /// <inheritdoc />
    public partial class spNewInList : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("CREATE PROCEDURE spNieuwInLijst");
        ...
        {
            migrationBuilder.Sql(@"DROP procedure spNieuwInLijst");
        }
    }
}
